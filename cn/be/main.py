...
class GeminiWrapper:
    def __init__(self):
        ...
        self.model = genai.GenerativeModel(
            ...
            system_instruction="You are a helpful assistant designed to help college students study for their exams. They will ask various questions regarding computer networks at a university level, and your job is to answer them. You are given context of 5 different past year question papers. Avoid generic advice."
        )
        ...
        self.file_paths = [
            os.path.join(script_dir, "Jan23.pdf"),
            os.path.join(script_dir, "Feb24.pdf"),
            os.path.join(script_dir, "Nov22.pdf"),
            os.path.join(script_dir, "Nov23.pdf"),
            os.path.join(script_dir, "Jun23.pdf")
        ]
